...
In S8, `guide now` starts a troubleshooting challenge affecting the learner's service or generated website. Further calls inspect the same challenge. Ask `guide` for hints; completion requires a working site and a one-sentence explanation of the cause and repair. Source files and other accounts are not modified.
